...
public class Driver {
	...
	void displayNumberOfEmployees() {
		...
		if(numemp > -1)
			System.out.println("Number of employees is: " + numemp +" (Look for other console messages.)"+n+CONTINUE);
		
	}
	
	void addEmployee(String employeeId){
		//implement-- redo the implementation
		boolean success = directory.addNewEmployee(employeeId);
		if(success)
	...
	void addBook(String bookId){
		//implement-- redo the implementation
		boolean success = directory.addNewBook(bookId);
	...
	void addCD(String cdId){
		//implement-- redo the implementation
		boolean success = directory.addNewCD(Integer.parseInt(cdId));
		if(success)
	...
	void checkIfBookIsInStock(String bookId){
		//implement-- redo the implementation
		boolean success = directory.bookIsInStock(bookId);
		if(success)
	...
	void checkWhetherFoodItemInMarket(String foodItem){
		//	implement-- redo the implementation
		boolean success = directory.marketCarriesFoodItem(foodItem);
		if(success)
